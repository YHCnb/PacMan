...
public init_map,draw_map,get_map_value,get_map_value_by_index,get_nxt_pos
...
player_PacMan player_struct <24, 13, Dir_Left, Dir_Left, 1, PacMan, 0, 0,1>
...
; 处理相遇
judge_meet proc uses esi edi ebx ecx edx
    ; 遍历4个幽灵
    mov esi, Blinky
    .while esi <= Clyde
