...
draw_PacMan PROC uses esi edi ecx eax ebx edx, index_x:dword, index_y:dword, dir:dword, frame_time:dword
    ...
    ;invoke StretchBlt,h_dc_bmp,0,0,mapGridWidth, mapGridWidth,@h_dc,0,0,pacman_size,pacman_size,SRCCOPY
    ...
    ;invoke TransparentBlt,h_dc_buffer[4*esi],@player_x,@player_y,@double_width, @double_width,h_dc_bmp,0,0,mapGridWidth,mapGridWidth,eax
...
draw_Ghost PROC uses esi edi ecx eax ebx edx, player:dword, index_x:dword, index_y:dword, dir:dword, frame_time:dword
    ...
    ;缩放到h_dc_bmp临时图片区
    ;StretchBlt hdcDest xDest yDest cxDest cyDest hdcSrc xSrc ySrc cxSrc cySrc dwRop
    ;invoke StretchBlt,h_dc_bmp,0,0,mapGridWidth, mapGridWidth,@h_dc,0,0,ghost_size,ghost_size,SRCCOPY
    ...
    ;将背景变透明放到h_dc_buffer[4*frametime]画面帧中,乘4是因为dword
    ;TransparentBlt hdcDest xDest yDest cxDest cyDest hdcSrc xSrc ySrc cxSrc cySrc transparentColor 
    ;invoke TransparentBlt,h_dc_buffer[4*esi],@player_x,@player_y,mapGridWidth, mapGridWidth,h_dc_bmp,0,0,mapGridWidth,mapGridWidth,eax
