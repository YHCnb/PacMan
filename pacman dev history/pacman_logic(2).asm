...
player_Pinky player_struct <16, 11, Dir_Up, Dir_Up, 1, Pinky, Ghost_State_Chase, 0,1>
player_Inky player_struct <14, 16, Dir_Left, Dir_Left, 1, Inky, Ghost_State_Chase, 0,1>
player_Clyde player_struct <16, 16, Dir_Up, Dir_Up, 1, Clyde, Ghost_State_Chase, 0,1>
...
player_move proc uses ecx, item:dword
    ...
    .if eax != -1
        ...
        .endif
    .else
        mov [ecx].player_struct.Dir, Dir_Stop
    .endif
    ret
player_move endp
