...
public enter_frightened,end_frightened,cycle_to_chase,cycle_to_scatter
; extern变量
...
player_PacMan player_struct <24, 10, Dir_Left, Dir_Left, 0, PacMan, 0, 0,1>
player_RedMan player_struct <24, 19, Dir_Right, Dir_Right, 0, RedMan, 0, 0,1>
player_Blinky player_struct <14, 11, Dir_Right, Dir_Right, 1, Blinky, Ghost_State_Chase, 0,1>
player_Pinky player_struct <16, 11, Dir_Right, Dir_Right, 1, Pinky, Ghost_State_Chase, 0,1>
player_Inky player_struct <14, 16, Dir_Left, Dir_Left, 1, Inky, Ghost_State_Chase, 0,1>
player_Clyde player_struct <16, 16, Dir_Left, Dir_Left, 1, Clyde, Ghost_State_Chase, 0,1>
...
change_ghost_state proc uses esi ebx, state:dword, changeFrightened:dword
    ...
    .while esi <= Cindy
        ...
        .if eax != Ghost_State_Eaten
            .if eax != Ghost_State_Frightened || changeFrightened == 1
                mov eax, state
...
init_map proc uses esi edi
    ...
    .while esi < map_size
        invoke  get_map_value_by_index, esi
        .if eax == Item_Bean || eax == Item_SuperBean || eax == Item_FastBean
            inc bean_count
        .elseif eax == Item_Portal
            ; 计算x,y
            xor edx,edx
