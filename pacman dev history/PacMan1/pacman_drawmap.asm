...
public is_super_pacman, is_fast_pacman, is_invisible_pacman, is_dying_pacman
public is_chasing_pacman, is_switching_chaseobj
...
superbean_time dword 1000000                ; time/dwlm=n(秒)时间间隔
is_fast_pacman dword 0
fastbean_time dword 1000000
is_invisible_pacman dword 0
invisiblebean_time dword 1000000

is_dying_pacman dword 0
dying_time dword 1000000

is_switching_chaseobj dword 0
switching_time dword 1000000
is_chasing_pacman dword 0
chasing_time dword 1000000
scatter_time dword 1000000
...
; 画豆子
    ...
    .while ebx < mapRow
        ...
        .while ecx < mapCol
            ...
            invoke getNum, ebx, ecx
            .if eax == Item_SuperBean || eax == Item_Portal || eax ==  Item_FastBean
...
;is_dying定时器，4秒
timer_isdying proc uses eax edx                     
    local time1:qword,time2:qword,freq:qword                                                   
    invoke QueryPerformanceFrequency, addr freq         ;获取高精度计时器的频率
    finit
    ...
    ; 检查 game_state 是否不等于 Game_State_NxtStage
    cmp is_dying_pacman, 1
    jne loop_is_dying

    invoke QueryPerformanceCounter,addr time1
    xor eax, eax
    .while eax < dying_time
        invoke QueryPerformanceCounter,addr time2
        mov eax,dword ptr time1             
        mov edx,dword ptr time1+4
        sub dword ptr time2, eax
...
play_music proc 
    ...
    .if play_theme_music == 1
        invoke playThemeMusic
        mov play_theme_music, 0
    .endif
    .if play_wake_music == 1
        invoke playWakeMusic
        mov play_wake_music, 0
    .endif
...
init_window proc, _hDc:HDC, hWnd: HWND
    ...
    invoke CreateThread, NULL, 0, timer_isdying, NULL, 0, NULL
